 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
	   ...
	   view = glm::translate(view, glm::vec3(0.0f,-0.0f,-10.0f));
		model = glm::rotate( model, 0.5f, glm::vec3( 1.0f, 2.0f, 3.0f ) ); // use to compare orthographic and perspective projection
		...
		model = glm::rotate(model, 0.5f, glm::vec3(1.0f, 3.0f, 1.0f));
